...
STREAM_SITE = (environ.get('STREAM_SITE', 'linksly.co'))
STREAM_API = (environ.get('STREAM_API', '8713c669d49f291774c8e23faf10d4060e924751'))
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'linksly.co')
SHORTLINK_API = environ.get('SHORTLINK_API', '8713c669d49f291774c8e23faf10d4060e924751')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/TCU_TCU')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TCU_TCU')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/TCU_CTU')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : TCU_TCU')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TCU_TCU') #Support group link ( make sure bot is admin )
...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'web-production-a6cba.up.railway.app/'
